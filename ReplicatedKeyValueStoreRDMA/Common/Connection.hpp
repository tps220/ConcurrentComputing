/*
  THIS IS A SIMPLE, UNOPTIMIZED IMPLEMENTATION OF SOCKET BASED COMMUNICATION
  the purpose of this layer is for transferring benchmark data to an auxilary node
*/
